            ...
            switch (args[0])
            {
                ...
                case "/myrole":
                    ...
                    if (GameStates.IsInGame)
                    {
                        ...
                        if (CustomRolesHelper.RoleExist(CustomRoles.Ntr) && (role is not CustomRoles.GM and not CustomRoles.Ntr and not CustomRoles.Lovers))
