                ...
                else
                {
                    ...
                    else 
                    {
                        if (target1.Is(CustomRoles.Aware))
                        {
                            ...
                            if (!Main.AwareInteracted[target1.PlayerId].Contains(CustomRoles.ParityCop)) Main.AwareInteracted[target1.PlayerId].Add(CustomRoles.ParityCop);
                        }
                        if (target2.Is(CustomRoles.Aware))
                        {
                            ...
                            if (!Main.AwareInteracted[target2.PlayerId].Contains(CustomRoles.ParityCop))  Main.AwareInteracted[target2.PlayerId].Add(CustomRoles.ParityCop);
                        }
                    } 
