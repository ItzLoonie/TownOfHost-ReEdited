...
namespace TOHE.Roles.Impostor
{
    public static class Twister
    {
        ...
        public static void SetupCustomOption()
        {
            ...
            ShapeshiftCooldown = FloatOptionItem.Create(Id + 10, "ShapeshiftCooldown", new(1f, 999f, 1f), 20f, TabGroup.ImpostorRoles, false).SetParent(CustomRoleSpawnChances[CustomRoles.Twister])
