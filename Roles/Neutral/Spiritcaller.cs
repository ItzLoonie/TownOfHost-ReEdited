...
namespace TOHE.Roles.Neutral
{
    public static class Spiritcaller
    {
        ...
        public static void SetupCustomOption()
        {
            ...
            SpiritAbilityCooldown = FloatOptionItem.Create(Id + 14, "SpiritcallerSpiritAbilityCooldown", new(0f, 90f, 1f), 20f, TabGroup.OtherRoles, false).SetParent(CustomRoleSpawnChances[CustomRoles.Spiritcaller])
                .SetValueFormat(OptionFormat.Seconds);
