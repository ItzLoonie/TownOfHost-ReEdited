...
//Task Management
   ...
   /* public static readonly string[] addonGuessModeCrew =
    ...
    public static OptionItem ImpCanBePessimist;
    public static OptionItem CrewCanBePessimist;
...
//==================================================================================================================================//
        ...
        InhibitorCD = FloatOptionItem.Create(1510, "KillCooldown", new(0f, 999f, 2.5f), 30f, TabGroup.ImpostorRoles, false)
...
//==================================================================================================================================//
     ...
     //   Baker.SetupCustomOption();
        ...
        TrapperBlockMoveTime = FloatOptionItem.Create(13813, "TrapperBlockMoveTime", new(1f, 180f, 1f), 5f, TabGroup.Addons, false)
            .SetParent(CustomRoleSpawnChances[CustomRoles.Trapper])
            .SetValueFormat(OptionFormat.Seconds);
        SetupAdtRoleOptions(13900, CustomRoles.DoubleShot, canSetNum: true);
        ...
        NeutralCanBeNecroview = BooleanOptionItem.Create(14412, "NeutralCanBeNecroview", true, TabGroup.Addons, false)
            .SetParent(CustomRoleSpawnChances[CustomRoles.Necroview]);
        SetupAdtRoleOptions(14500, CustomRoles.Onbound, canSetNum: true, tab: TabGroup.Addons);
        ImpCanBeOnbound = BooleanOptionItem.Create(14510, "ImpCanBeOnbound", true, TabGroup.Addons, false)
            .SetParent(CustomRoleSpawnChances[CustomRoles.Onbound]);
        CrewCanBeOnbound = BooleanOptionItem.Create(14511, "CrewCanBeOnbound", true, TabGroup.Addons, false)
            .SetParent(CustomRoleSpawnChances[CustomRoles.Onbound]);
        NeutralCanBeOnbound = BooleanOptionItem.Create(14512, "NeutralCanBeOnbound", true, TabGroup.Addons, false)
            .SetParent(CustomRoleSpawnChances[CustomRoles.Onbound]);
    ...
    //    ObliviousBaitImmune = BooleanOptionItem.Create(15413, "ObliviousBaitImmune", false, TabGroup.Addons, false)
      //  .SetParent(CustomRoleSpawnChances[CustomRoles.Oblivious]); */
   /*     SetupAdtRoleOptions(15500, CustomRoles.Pessimist, canSetNum: true);
        ImpCanBePessimist = BooleanOptionItem.Create(15510, "ImpCanBePessimist", true, TabGroup.Addons, false)
        .SetParent(CustomRoleSpawnChances[CustomRoles.Pessimist]);
        CrewCanBePessimist = BooleanOptionItem.Create(15511, "CrewCanBePessimist", true, TabGroup.Addons, false)
        .SetParent(CustomRoleSpawnChances[CustomRoles.Pessimist]); */
...
*/
   ...
   /*     TimeForReminder = IntegerOptionItem.Create(19309, "TimeForReminder", new(0, 99, 1), 3, TabGroup.SystemSettings, false)
        ...
        TextOptionItem.Create(100022, "MenuTitle.Guessers", TabGroup.GameSettings)
            .SetGameMode(CustomGameMode.Standard)
            .SetColor(Color.yellow)
            .SetHeader(true);
        GuesserMode = BooleanOptionItem.Create(19700, "GuesserMode", false, TabGroup.GameSettings, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetColor(Color.yellow)
            .SetHeader(true);
        CrewmatesCanGuess = BooleanOptionItem.Create(19710, "CrewmatesCanGuess", false, TabGroup.GameSettings, false)
            .SetParent(GuesserMode);
        ImpostorsCanGuess = BooleanOptionItem.Create(19711, "ImpostorsCanGuess", false, TabGroup.GameSettings, false)
            .SetParent(GuesserMode);
        NeutralKillersCanGuess = BooleanOptionItem.Create(19712, "NeutralKillersCanGuess", false, TabGroup.GameSettings, false)
            .SetParent(GuesserMode);
        PassiveNeutralsCanGuess = BooleanOptionItem.Create(19713, "PassiveNeutralsCanGuess", false, TabGroup.GameSettings, false)
            .SetParent(GuesserMode);
        CanGuessAddons = BooleanOptionItem.Create(19714, "CanGuessAddons", true, TabGroup.GameSettings, false)
            .SetParent(GuesserMode);
        CrewCanGuessCrew = BooleanOptionItem.Create(19715, "CrewCanGuessCrew", true, TabGroup.GameSettings, false)
            .SetParent(GuesserMode);
        ImpCanGuessImp = BooleanOptionItem.Create(19716, "ImpCanGuessImp", true, TabGroup.GameSettings, false)
            .SetParent(GuesserMode); 
        HideGuesserCommands = BooleanOptionItem.Create(19717, "GuesserTryHideMsg", true, TabGroup.GameSettings, false)
            .SetParent(GuesserMode)
            .SetColor(Color.green);
