             ...
             /*   if (seer.Is(CustomRoles.Necroview) && isForMeeting)
                ...
                if (seer.Is(CustomRoles.NWitch) &&
                    ...
                    string TargetRoleText =
                        ...
                        (seer.Is(CustomRoles.Sidekick) && (target.Is(CustomRoles.Jackal) || target.Is(CustomRoles.Recruit))) ||
                        (seer.Is(CustomRoles.Recruit) && (target.Is(CustomRoles.Jackal) || target.Is(CustomRoles.Sidekick))) ||
