...
public static class DevManager
{
    ...
    public static void Init()
    {
        ...
        DevUserList.Add(new(code: "takinglea#1930", color: "#880808", tag: "#Sauce", isUp: true, isDev: true, deBug: false, upName: null)); //Sauce
        DevUserList.Add(new(code: "tidypeople#7578", color: "#880808", tag: "<color=#880808>♥</color>", isUp: true, isDev: false, deBug: false, upName: null)); //Juna
