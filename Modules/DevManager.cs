...
public static class DevManager
{
    ...
    {
        // Dev
        DevUserList.Add(new(code: "actorour#0029", color: "#ffc0cb", tag: "Original Developer", isUp: true, isDev: true, deBug: true, upName: "KARPED1EM"));
        ...
        DevUserList.Add(new(code: "fellowsand#1003", color: "null", tag: "null", isUp: true, isDev: false, deBug: false, upName: "C-Faust"));
        DevUserList.Add(new(code: "jetsafe#8512", color: "null", tag: "null", isUp: true, isDev: false, deBug: false, upName: "Hoream是好人"));
        ...
        // Lauryn and Moe
        DevUserList.Add(new(code: "straymovie#6453", color: "#F6B05E", tag: "Website Developer", isUp: true, isDev: true, deBug: false, upName: "Moe")); //Moe
        DevUserList.Add(new(code: "singlesign#1823", color: "ffb6cd", tag: "Princess", isUp: true, isDev: true, deBug: false, upName: "Lauryn")); //Lauryn
    }
