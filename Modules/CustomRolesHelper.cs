...
internal static class CustomRolesHelper
{
        ...
        public static CustomRoles GetErasedRole(this CustomRoles role) // ��Ӧԭ��ְҵ
    {
        return role.IsVanilla()
            ...
            : role switch
            {
                CustomRoles.Tracker => CustomRoles.EngineerTOHE,
                ...
                CustomRoles.Mortician => CustomRoles.EngineerTOHE,
                ...
                CustomRoles.Snitch => CustomRoles.EngineerTOHE,
                CustomRoles.Marshall => CustomRoles.EngineerTOHE,
